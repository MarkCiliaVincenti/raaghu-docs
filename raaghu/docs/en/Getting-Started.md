...
This tutorial assumes that you've already purchased an (#heading-ids) [ABP Commercial license](https://commercial.abp.io/pricing) and have an active ABP Commercial account.

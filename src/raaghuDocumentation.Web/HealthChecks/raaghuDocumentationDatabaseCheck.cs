...
public class raaghuDocumentationDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public raaghuDocumentationDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
